...
void st_clear_track_wrap(XMNote* n,
    int tracklength,
    int clearstart,
    int clearlength)
{
...
void st_paste_track_into_track_wrap(XMNote* from,
    XMNote* to,
    int tolength,
    int insertstart,
    int fromlength)
...
void st_clean_instrument(STInstrument* instr,
    const char* name)
{
    int i;
...
void st_set_pattern_length(XMPattern* pat,
    int l)
{
    int i;
    XMNote* n;
